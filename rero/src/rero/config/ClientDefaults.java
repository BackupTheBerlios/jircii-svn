...
public class ClientDefaults
{
   ...
   public static       Font    ui_font        = new Font("Monospaced", Font.PLAIN, 13);
   ...
   public static final String  version_string = "08.07.08";
   ...
   static
   {
      if (System.getProperty("os.name").indexOf("indows") > -1)
      {
         ...
         ui_sdi       = false;
         ui_font      = new Font("Courier New", Font.PLAIN, 13); // sun's monospace looks like garbage on OS X, had to use Courier
      }
      else if (System.getProperty("os.name").equals("Mac OS X"))
      {
         ui_openfiles = "/usr/bin/open";
         ui_font      = new Font("Courier New", Font.PLAIN, 13); // sun's monospace looks like garbage on Windows, had to use Courier
         ui_antialias = true;
      }
      else
      {
